...
if __name__ == '__main__':
    ...
    instruction= """
        ...
        ### 규칙 ###
        1. 사진이 있을 경우:
            - 못 입었다고 판단하면, 가차 없이 직설적으로 말해. 친절하게 말하지 말고, 웃기면서도 상처 줄 정도로 신랄하게 비판해. 절대 순화하지 마. 비판은 최소 한 문장, 개선 팁은 한 문장으로. 예를 들어 "이건 패션 범죄야. 당장 저 셔츠부터 버려."
        ...
        5. 못 입은 경우에는 절대 "괜찮아요", "좋아요" 같은 긍정 표현을 하지 마. 무조건 부정적으로 시작해.
        """
